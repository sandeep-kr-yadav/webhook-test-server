...
curl -X POST https://webhook-server-test.railway.app/webhook \
...
echo -e "\n\n=== Test case 1 completed ===\nCheck the web UI at https://webhook-server-test.railway.app to see the result.\n"
...
echo "Check the web UI at https://webhook-server-test.railway.app to see all results."
